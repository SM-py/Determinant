...
Так же нужно в папке проекта создать папку geowac и в нее распаковать содержимок архива: https://drive.google.com/file/d/1r83gtBktdXBgdfxlsevUZbOsubpnlRlN/view?usp=drive_link
В папку проекта нужно догрузить файл ruwordnet.db: https://drive.google.com/file/d/1RKCAN-6hO4Oqaswh2bMZaU4iMR7CyxHL/view?usp=drive_link
